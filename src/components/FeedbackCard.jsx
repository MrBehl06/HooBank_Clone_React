...
const FeedbackCard = (props) => (
    <div className='flex justify-betwen flex-col px-10 py-12 rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card'>
      ...
      <div className='flex flex-row '>
        <img src={props.img} alt="person" className='w-[48px] h-[48px] rounded-full'/>
